...
EXPNAME=qwen7b-kodcode_instruct_9k-rm-lr$LR$lr_scheduler_type-bs$batch_size-accum$gradient_accumulation_steps-epslow$eps_low-high$eps_high-ngen$num_generations-t$temperature-epoch$num_epochs-$TIMESTAMP

output_dir=runs/$EXPNAME
LOG_PATH=logs/${EXPNAME}
mkdir -p $LOG_PATH

ARGS="train_grpo_kodcode_rm.py \
